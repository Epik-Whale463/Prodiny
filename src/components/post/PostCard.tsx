        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            {post.subgroup_name && post.subgroup_name !== 'General' && (
              <>
                <span>·</span>
                <Badge variant="secondary" className="text-xs accent-blue-bg">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="h-6 w-6 p-0 button-press">
            ...
            <DropdownMenuContent align="end" className="glass-card">
              ...
              <DropdownMenuItem className="interactive-hover">Report</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </CardHeader>
      ...
      <CardContent className="pt-0">
        <div className="flex gap-4">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Button
                  ...
                  className="text-muted-foreground hover:text-foreground button-press accent-blue"
                >
            ...
            {/* Comments section */}
            {showComments && (
              <div className="space-y-4 pt-4 border-t scale-in">
